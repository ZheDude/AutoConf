...
<div class="TrunkRangeDiv">
	<InputField bind:value={parameters.InterfaceRanges[count].startInterface} placeholder="Gig0/1" type="text" fieldName="Start-Interface:" id="EtherChannelInterfaceRange{count}.1" />
	<InputField bind:value={parameters.InterfaceRanges[count].endInterface} placeholder="Gig0/1" type="text" fieldName="End-Interface:" id="EtherChannelInterfaceRange{count}.2" />
</div>

{/each}


<button class="VtyButton"  on:click={addInterfaceRange} id="uniqueRight">Add Interface Range</button>
<button class="VtyButton" on:click={removeInterfaceRange} id="uniqueRight">Remove Interface Range</button>
